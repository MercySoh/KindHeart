...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2025 at 06:45 AM
...
--
-- Database: `kindhearttest`
--
CREATE DATABASE IF NOT EXISTS `kindhearttest` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `kindhearttest`;
...
(3, 3, 'Instant noodles', 'Unopened Koka Chicken Noodle - 10 Pack X 850G - Best before: 18 September 2025', 3, 'Food', 'default.png', 2, '2025-02-19'),
...
(1, 'donor', 'donor@example.com', '$2a$10$LdZyn55grv70TVFYOYUOCulDHnNfgRoRUAvZC.c359yO9nAJXnCU2', 'default.png	', 1),
(2, 'recipient', 'recipient@example.com', '$2a$10$LdZyn55grv70TVFYOYUOCulDHnNfgRoRUAvZC.c359yO9nAJXnCU2', 'default.png', 2),
(3, 'Alen', 'alen@example.com', '$2a$10$LdZyn55grv70TVFYOYUOCulDHnNfgRoRUAvZC.c359yO9nAJXnCU2', 'default.png', 1),
(4, 'Dundalk Food Bank', 'dundalkfoodbank@example.com', '$2a$10$LdZyn55grv70TVFYOYUOCulDHnNfgRoRUAvZC.c359yO9nAJXnCU2', 'default.png', 2),
(5, 'Hannah', 'hannah@example.com', '$2a$10$LdZyn55grv70TVFYOYUOCulDHnNfgRoRUAvZC.c359yO9nAJXnCU2', 'default.png', 1),
(6, 'Charity House', 'Charityhouse@example.com', '$2a$10$LdZyn55grv70TVFYOYUOCulDHnNfgRoRUAvZC.c359yO9nAJXnCU2', 'default.png', 2);
...
--
ALTER TABLE `donations`
  MODIFY `donationId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `itemrequests`
--
ALTER TABLE `itemrequests`
  MODIFY `itemRequestId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
